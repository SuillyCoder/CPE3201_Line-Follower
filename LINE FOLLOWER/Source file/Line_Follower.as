...
;;  sensor          1    1[COMMON] unsigned char 
...
l477:	
;Line_Follower.c: 14: unsigned char sensor;
;Line_Follower.c: 15: TRISB = 0xC0;
	movlw	(0C0h)
...
l479:	
;Line_Follower.c: 16: TRISD = 0x00;
	clrf	(136)^080h	;volatile
	line	18
;Line_Follower.c: 18: while (1)
	
l11:	
	line	20
;Line_Follower.c: 19: {
;Line_Follower.c: 20: sensor = PORTB & 0xC0;
	...
	movwf	(main@sensor)
	line	21
;Line_Follower.c: 21: switch (sensor)
	goto	l491
	line	23
;Line_Follower.c: 22: {
;Line_Follower.c: 23: case 0x40:
...
; Number of cases is 3, Range of values is 64 to 192
